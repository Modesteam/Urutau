...
public class ProjectController {
	...
	public ProjectController(Result result, UserSession userSession, ProjectService projectService,
			UserService userService, KanbanService kanbanService, FlashMessage flash,
	...
	public void create(final @Valid Project project) {
		...
		if (!projectService.titleAvaliable(project.getTitle())) {
			...
			try {
				...
				flash.use("success").toShow("project_created").redirectTo(ProjectController.class)
						.show(basicProject);
	...
	public void delete(final Project project) {
		...
		flash.use("warning").toShow("project_deleted").redirectTo(ProjectController.class).index();
	}
	...
	public Project show(Project project) {
		...
		if ((!targetProject.getId().equals(project.getId()))) {
			flash.use("error").toShow("invalid_link").redirectTo(ProjectController.class).index();
			return null;
		} else {
